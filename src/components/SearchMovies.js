...
function SearchMovies() {
	...
	// Credenciales de API
	const apiKey = 'https://www.omdbapi.com/?i=tt3896198&apikey=f289c6f5'; // Intenta poner cualquier cosa antes para probar
	...
	useEffect(() => {
		if (searchValue) {
			fetch(`http://www.omdbapi.com/?s=${searchValue}&apikey=f289c6f5`)
				.then(response => {
